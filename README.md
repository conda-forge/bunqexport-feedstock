...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/bunqexport-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14188&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/bunqexport-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `bunqexport` can be installed with:

```
conda install bunqexport
```

It is possible to list all of the versions of `bunqexport` available on your platform with:
